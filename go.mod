module github.com/knockbox/matchbox
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudformation v1.54.0 // indirect
	github.com/aws/aws-sdk-go-v2/service/efs v1.32.0 // indirect
